This is a DBS student and property owner console application that help user to check the prices rate for same property but in a different location. E.g the rate for a property with an address in 
